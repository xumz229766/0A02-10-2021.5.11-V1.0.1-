...
namespace Motion.Enginee
{
    ...
    public class ApsAxis : Axis, INeedClean
    {
        ...
        {
            ApsController.SetCommandPosition(NoId,0);
        }

        public void GetCurrentFeedbackPosition()
        {
            ApsController.SetFeedbackPosition(NoId, 0);
        }
        public override void Initialize()
        {
            ApsController.BackHome(NoId);
        }
