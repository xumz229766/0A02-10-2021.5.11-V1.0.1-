...
namespace System.Enginee
{
    ...
    /// 三气缸共用电磁阀控制块
    /// </summary>
    public class SingleCylinder3 : Cylinder, ICylinderStatusJugger
    {
        #region "字段"
        ...
        private IoPoint _InOrigin1, _InOrigin2, _InOrigin3, _InMove1, _InMove2, _InMove3, _OutMove;
        ...
        #endregion
        public SingleCylinder3(IoPoint InOrigin1, IoPoint InOrigin2, IoPoint InOrigin3, IoPoint InMove1, IoPoint InMove2, IoPoint InMove3, IoPoint OutMove)
        {
        ...
        private bool NoOriginAlarm()
        {
            ...
            if (Condition.External.AirSignal && !_OutMove.Value && (!_InOrigin1.Value || !_InOrigin2.Value || !_InOrigin3.Value)) cylinderNoOrigin = true;
        ...
        private bool NoMoveAlarm()
        {
            ...
            bool alarmDelayDone = false;
            if (Condition.External.AirSignal && _OutMove.Value && (!_InMove1.Value || !_InMove2.Value || !_InMove3.Value)) cylinderNoMove = true;
        ...
        private bool OffMoveAlarm()
        {
            ...
            bool alarmDelayDone = false;
            if (Condition.External.AirSignal && !_OutMove.Value && _InMove1.Value && _InMove2.Value && _InMove3.Value) cylinderOffMove = true;
        ...
        private bool OnOriginAlarm()
        {
            ...
            bool alarmDelayDone = false;
            if (Condition.External.AirSignal && _OutMove.Value && _InOrigin1.Value && _InOrigin2.Value && _InOrigin3.Value) cylinderOnOrigin = true;
        ...
        {
            //原点状态输出
            if (!_OutMove.Value && ((_InOrigin1.Value && _InOrigin2.Value && _InOrigin3.Value && !Condition.NoOriginShield)
            ...
            //动点状态输出
            if (_OutMove.Value && ((_InMove1.Value && _InMove2.Value && _InMove3.Value && !Condition.NoMoveShield)
