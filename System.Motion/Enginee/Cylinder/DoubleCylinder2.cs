...
namespace System.Enginee
{
    ...
    /// 双向电磁阀气缸类
    /// </summary>
    public class DoubleCylinder2 : Cylinder, ICylinderStatusJugger
    {
        #region "字段"
        ...
        private IoPoint _InOrigin1, _InOrigin2, _InMove1, _InMove2, _OutOrigin, _OutMove;
        ...
        /// <param name="OutOrigin">原点输出</param>
        /// <param name="OutMove">动点输出</param>
        public DoubleCylinder2(IoPoint InOrigin1, IoPoint InOrigin2, IoPoint InMove1, IoPoint InMove2, IoPoint OutOrigin, IoPoint OutMove)
        {
        ...
        private bool NoOriginAlarm()
        {
            ...
            if (Condition.External.AirSignal && _OutOrigin.Value && !_OutMove.Value && !_InOrigin1.Value && !_InOrigin2.Value) cylinderNoOrigin = true;
        ...
        {
            bool alarmDelayDone = false;
            if (Condition.External.AirSignal && !_OutOrigin.Value && _OutMove.Value && !_InMove1.Value && !_InMove2.Value) cylinderNoMove = true;
        ...
        {
            bool alarmDelayDone = false;
            if (Condition.External.AirSignal && _OutOrigin.Value && !_OutMove.Value && _InMove1.Value && _InMove2.Value) cylinderOffMove = true;
        ...
        {
            bool alarmDelayDone = false;
            if (Condition.External.AirSignal && !_OutOrigin.Value && _OutMove.Value && _InOrigin1.Value && _InOrigin2.Value) cylinderOnOrigin = true;
        ...
        public void StatusJugger()
        {
            ...
            //动点状态输出
            if (!_OutOrigin.Value && ((_InMove1.Value && _InMove2.Value && !Condition.NoMoveShield)
