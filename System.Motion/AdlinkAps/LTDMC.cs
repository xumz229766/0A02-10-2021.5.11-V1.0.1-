...
namespace csLTDMC //命名空间根据应用程序修改
{
    public class LTDMC
    {
        ...
        public static extern short dmc_set_can_state(UInt16 CardNo,UInt16 NodeNum,UInt16 state);
        ...
        public static extern short dmc_set_vector_s_profile(UInt16 CardNo, UInt16 Crd, UInt16 s_mode, double s_para);   //单段插补速度S型参数
        [DllImport("LTDMC.dll", EntryPoint = "dmc_get_vector_s_profile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_get_vector_s_profile(UInt16 CardNo, UInt16 Crd, UInt16 s_mode,ref double s_para);   //读取单段插补速度S型参数
        ...
        [DllImport("LTDMC.dll", EntryPoint = "dmc_conti_set_speed_unit", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_conti_set_speed_unit(UInt16 CardNo, UInt16 Crd, double Max_vel);      //设置连续插补运行速度
        [DllImport("LTDMC.dll", EntryPoint = "dmc_conti_set_taccdec", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_conti_set_taccdec(UInt16 CardNo, UInt16 Crd, double Taccdec);      //设置连续插补速度曲线的加减速时间
        ...
        public static extern short dmc_set_pwm_enable(UInt16 CardNo, UInt16 enable);      //设置PWM使能状态
        [DllImport("LTDMC.dll", EntryPoint = "dmc_get_pwm_enable", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_get_pwm_enable(UInt16 CardNo, ref UInt16 enable);      //读取PWM使能状态设置
        [DllImport("LTDMC.dll", EntryPoint = "dmc_conti_set_pwm_output", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_conti_set_pwm_output(UInt16 CardNo,UInt16 Crd,UInt16 pwm_no,double fDuty,double fFre);     //连续插补中设置PWM输出
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_pwm_output", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_set_pwm_output(UInt16 CardNo,UInt16 pwm_no,double fDuty,double fFre);     //设置PWM输出
        [DllImport("LTDMC.dll", EntryPoint = "dmc_get_pwm_output", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_get_pwm_output(UInt16 CardNo,UInt16 pwm_no,ref double fDuty,ref double fFre);     //读取PWM输出设置
        ...
        [DllImport("LTDMC.dll", EntryPoint = "dmc_conti_delay_pwm_to_stop", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("LTDMC.dll", EntryPoint = "dmc_line_unit1", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_line_unit1(UInt16 CardNo,UInt16 Crd,UInt16 AxisNum, UInt16[] AxisList, double[] Target_Pos,UInt16 posi_mode,double MaxVel,double Taccdec); 
        [DllImport("LTDMC.dll", EntryPoint = "dmc_arc_move_center_unit1", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_arc_move_center_unit1(UInt16 CardNo,UInt16 Crd,UInt16 AxisNum,UInt16[] AxisList,double[] Target_Pos,double[] Cen_Pos,UInt16 Arc_Dir,Int32 Circle,UInt16 posi_mode,double MaxVel,double Taccdec); 
        [DllImport("LTDMC.dll", EntryPoint = "dmc_arc_move_radius_unit1", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_arc_move_radius_unit1(UInt16 CardNo,UInt16 Crd,UInt16 AxisNum,UInt16[] AxisList,double[] Target_Pos,double Arc_Radius,UInt16 Arc_Dir,Int32 Circle,UInt16 posi_mode,double MaxVel,double Taccdec);
        [DllImport("LTDMC.dll", EntryPoint = "dmc_arc_move_3points_unit1", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_arc_move_3points_unit1(UInt16 CardNo,UInt16 Crd,UInt16 AxisNum,UInt16[] AxisList,double[] Target_Pos,double[] Mid_Pos,Int32 Circle,UInt16 posi_mode,double MaxVel,double Taccdec); 
        [DllImport("LTDMC.dll", EntryPoint = "dmc_conti_line_unit1", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_conti_line_unit1(UInt16 CardNo,UInt16 Crd,UInt16 AxisNum,UInt16[] AxisList,double[] Target_Pos,UInt16 posi_mode,Int32 mark,double MaxVel,double Taccdec); 
