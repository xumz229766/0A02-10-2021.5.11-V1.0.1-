...
namespace System.Tray
{
    ...
    public class UTray: ITary
    {
        ...
        public UTray(string type, string name, int Row, int Column)
        {
            Type = type;
            Name = name;
            this.Row = Row;
