...
{
    public class Gryphon_GFS4400 : SerialPort, ISerialPortTriggerModel
    {
        /*
        ...
        public Gryphon_GFS4400(string portName, int baudRate, Parity parity, int dataBits, StopBits stopBits) : base(portName, baudRate, parity, dataBits, stopBits) { }
